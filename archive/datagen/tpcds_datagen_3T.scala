...
val rootDir = s"hdfs://fqdn.or.ip:9000/data22/tpcds_sf$scaleFactor-$format/useDecimal=$useDecimal,useDate=$useDate,filterNull=$filterNull"
...
val tables = new TPCDSTables(sqlContext, dsdgenDir = "/home/rladmin/tpc-ds/tpcds-kit/tools", scaleFactor = scaleFactor, useDoubleForDecimal = !useDecimal, useStringForDate = !useDate)
